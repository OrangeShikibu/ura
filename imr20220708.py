...
df_wos_imr.to_excel(home + "/result/wos_imr_20220708a.xlsx")
...
df_scps2021.to_excel(home + "/result/scps2021_20220708.xlsx")
scpsdoi = []
...
df_scpsWos2021.to_excel(home + "/result/scpsWos2021_20220708.xlsx")
df_wosScp2021.to_excel(home + "/result/wosScps2021_20220708a.xlsx")
df_scpsNotWos2021.to_excel(home + "/result/scpsNotWos2021_20220708.xlsx")
df_wosNotScp2021.to_excel(home + "/result/wosNotScps2021_20220708.xlsx")
...
len(df_tudb_c)
len(df_tudb_c2)
df_tudb_c2.to_excel(home + "/result/東北大DBデータ確認用_20220708.xlsx")
